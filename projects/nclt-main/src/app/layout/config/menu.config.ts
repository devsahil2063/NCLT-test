import { MenuSection } from '../services/navigation.service';

/**
 * Complete menu structure configuration
 * Defines all menu sections, items, and their hierarchical relationships
 */
                                        ...
                                        children: [
                                            {
                                                ...
                                                icon: 'pi-file',
                                                route: '/cases/cirp/admission/filing/details'
                                            },
                                            {
                                                id: 'applicant-details',
                                                label: 'Applicant Details',
                                                icon: 'pi-user-plus',
                                                route: '/cases/cirp/admission/filing/applicant'
                                            },
                                            {
                                                id: 'documents',
                                                label: 'Documents',
                                                icon: 'pi-clock',
                                                route: '/cases/cirp/admission/filing/documents'
                                            }
                                        ]
                                    },
                                    {
